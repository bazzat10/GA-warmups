...
var index1 = Math.floor((Math.random() * thisArray.length));
var index2 = Math.floor((Math.random() * thatArray.length));

console.log("Random Idea: " + thisArray[index1] + " " + thatArray[index2]);
//console.log(number);
